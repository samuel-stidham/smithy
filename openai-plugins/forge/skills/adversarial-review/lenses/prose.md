...
The lens pack for articles and manuscripts. The `adversarial-review`
...
- **Citation integrity.** Per the `citations` skill. Every in-text
  citation has a matching reference. Every reference is real. No
  claim leans on a source that does not support it.
