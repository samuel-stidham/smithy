...
`forge:web-browsing`, and `forge:conventional-commits` by name.
Install and enable forge wherever draft runs.

- `/draft:write [task]` writes manuscript content or articles in the
  project's own voice.
